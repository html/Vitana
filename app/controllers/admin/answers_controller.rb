...
class Admin::AnswersController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Answer: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Answer: create, read, update, custom_action_for_an_item
  #
